...
{
# 114 "C:/Users/user/workspace/module_usb_audio/ports/audioports.xc"
    ...
    if(curSamFreq * 2 * 32 >= 20000000)
    {

        bClkDelay_fall = 18;
    }

    __builtin_set_clock_fall_delay (clk_audio_bclk, bClkDelay_fall);
    ...
    configure_in_port(p_lrclk, clk_audio_bclk);
