...
# 427 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc"
on tile[0]: port p_scl = on tile[0]: 0x10800;
on tile[0]: port p_sda = on tile[0]: 0x10a00;

const char i2c_device_addr = 44;

[[combinable]]
static void i2c_client(server i2c_slave_callback_if i_i2c, client interface control i_control[(3)])
{
  while (1) {
    select {
