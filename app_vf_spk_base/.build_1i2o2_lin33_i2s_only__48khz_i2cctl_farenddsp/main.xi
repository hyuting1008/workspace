...
on tile[1] : buffered out port:32 p_i2s_dac[(4 / 2)] =
                {on tile[1]: 0x10300,
...
# 127 "C:/Users/user/workspace/module_usb_audio/main.xc"
on tile[1] : buffered in port:32 p_lrclk = on tile[1]: 0x10d00;
on tile[1] : buffered in port:32 p_bclk = on tile[1]: 0x10c00;
...
# 573 "C:/Users/user/workspace/module_usb_audio/main.xc"
    ...
    par
    {
        on tile[0].core[0]: BeclearBuff(i_audMan, i_beclear); on tile[0]: BeClear_SmartTV_AEC(chan_aec, chan_erl, i_beclear, i_control[0]); on tile[1]: { dsp_init_chanend(c_dsp); led_init_chanend(c_led); BeClear_SmartTV_BAP(chan_aec, chan_erl, i_control[1]); } on tile[(0)]: i2c_ctrl(i_control); on tile[0].core[0]: led_controller(c_led); on tile[1]: far_end_dsp(c_dsp, i_control[(3)-1]);
