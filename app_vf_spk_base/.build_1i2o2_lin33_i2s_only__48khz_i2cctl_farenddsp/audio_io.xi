...
static unsigned samplesOut[((2)>(4) ? (2) : (4))];
# 52 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
static unsigned samplesIn[2][((2)>((2 + 4 + (8*0) + (2*0))) ? (2) : ((2 + 4 + (8*0) + (2*0))))];
# 63 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
...
# 64 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc" 2
# 86 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
extern buffered out port:32 p_i2s_dac[(4 / 2)];
...
# 307 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
...
{
    unsigned tmp;
# 415 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
    p_lrclk when __builtin_pins_eq(0) :> void;
    p_lrclk when __builtin_pins_eq(1) :> void;
    p_lrclk when __builtin_pins_eq(0) :> void;
    p_lrclk when __builtin_pins_eq(1) :> void;
    ...
    p_lrclk when __builtin_pins_eq(0) :> void @ tmp;
...
# 504 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
    ...
    union i2sInDs3
    {
        ...
        int32_t delayLine[2][(3)][(24)];
    } i2sInDs3;
    _safe_memset((char *)&i2sInDs3.delayLine, 0, sizeof i2sInDs3.delayLine);
    int64_t i2sInDs3Sum[2];

    union i2sOutUs3
    {
        long long doubleWordAlignmentEnsured;
        int32_t delayLine[4][(24)];
    } i2sOutUs3;
    _safe_memset((char *)&i2sOutUs3.delayLine, 0, sizeof i2sOutUs3.delayLine);
...
# 686 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
            {
                ...
                {
                    _safe_memset((char *)&i2sInDs3Sum, 0, sizeof i2sInDs3Sum);
                }
 ...
 for(int i = 0; i < 2; i+=2)
                {
                    ...
                    sample = __builtin_bitrev(sample);
                    int chanIndex = ((frameCount-2)&(2 -1))+i;

                    if ((3 - 1) == audioToUsbRatioCounter)
                    {
...
# 758 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
...
# 792 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
            if(frameCount == 0)
            {
 ...
 for(int i = 0; i < 2; i += 2)
                {
                    ...
                    unsigned lrval;
                    p_lrclk :> lrval;
# 870 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
                    syncError += (lrval != 0x7FFFFFFF);



                    sample = __builtin_bitrev(sample);
                    int chanIndex = ((frameCount-1)&(2 -1))+i;
...
# 912 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
                index = 0;
...
# 942 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
            }
...
# 1056 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
#pragma select handler
...
# 1284 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
        ...
        if(!firstRun)
        {
            ...
            if (((curSamFreq / 3) != (0xa5a5a5a5)) && ((curSamFreq / 3) != (0x12345678)) && command)
            {
# 1307 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
            }
        }
        firstRun = 0;
