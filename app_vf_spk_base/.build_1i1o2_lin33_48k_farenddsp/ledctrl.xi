# 1 "../src/extensions/ledctrl.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/extensions/ledctrl.xc" 2
...
# 14 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.3\\target/include\\sys/reent.h" 2 3
...
# 5 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.3\\target/include\\math.h" 2 3
...
# 9 "../src/extensions/ledctrl.xc" 2
unsafe chanend c_led;
# 19 "../src/extensions/ledctrl.xc"
on tile[0]: out port p_led0_to_7 = on tile[0]: 0x80200;
on tile[0]: out port p_led8 = on tile[0]: 0x10900;
on tile[0]: out port p_led9 = on tile[0]: 0x10b00;
on tile[0]: out port p_led10_to_12 = on tile[0]: 0x80300;
...
inline void led12_high(void)
{
  ...
  unsigned port_value = __builtin_peek(p_led10_to_12);
