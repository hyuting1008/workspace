...
# 1 "C:\\\\Users\\\\user\\\\workspace\\\\app_vf_spk_base\\\\.build_1i1o2_lin33_48k_farenddsp\\\\vfspk_base_usb.h" 1 3
...
# 5 "C:\\\\Users\\\\user\\\\workspace\\\\app_vf_spk_base\\\\.build_1i1o2_lin33_48k_farenddsp\\\\vfspk_base_usb.h" 2 3
...
int VendorRequests(XUD_ep ep0_out, XUD_ep ep0_in, USB_SetupPacket_t &sp );

void VendorRequests_Init();
...
# 386 "C:/Users/user/workspace/module_usb_audio/main.xc"
        ...
        {
            thread_speed();
            Endpoint0( c_xud_out[0], c_xud_in[0], c_aud_ctl, null, c_clk_ctl, null, dfuInterface );
        }
...
# 567 "C:/Users/user/workspace/module_usb_audio/main.xc"
    ...
    interface beclear_if i_beclear; chan chan_aec[4]; chan chan_erl; chan c_led; chan c_dsp;
    par
    {
        on tile[0].core[0]: BeclearBuff(i_audMan, i_beclear); on tile[0]: BeClear_SmartTV_AEC(chan_aec, chan_erl, i_beclear, null); on tile[1]: { dsp_init_chanend(c_dsp); led_init_chanend(c_led); BeClear_SmartTV_BAP(chan_aec, chan_erl, null); } on tile[0].core[0]: led_controller(c_led); on tile[0]: far_end_dsp(c_dsp, i_control[(1)-1]);
# 595 "C:/Users/user/workspace/module_usb_audio/main.xc"
        ...
        par
        {
# 659 "C:/Users/user/workspace/module_usb_audio/main.xc"
            usb_audio_core(c_mix_out
# 672 "C:/Users/user/workspace/module_usb_audio/main.xc"
...
# 760 "C:/Users/user/workspace/module_usb_audio/main.xc"
...
# 779 "C:/Users/user/workspace/module_usb_audio/main.xc"
    }
