# 1 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc" 2
...
# 4 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc" 2
# 16 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc"
...
# 17 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc" 2
# 1 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.3\\target/include/clang\\stddef.h" 1 3
# 18 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc" 2
...
# 19 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc" 2
...
# 20 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc" 2
...
# 21 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc" 2
...
# 23 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc" 2
...
# 17 "C:/Users/user/workspace/lib_xbeclear/api\\xbeclear.h"
...
# 25 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc" 2
...
# 66 "C:/Users/user/workspace/lib_xbeclear/inc/APEStypes.h"
...
# 67 "C:/Users/user/workspace/lib_xbeclear/inc/APEStypes.h" 2
...
# 27 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc" 2




# 1 "C:/Users/user/workspace/lib_xbeclear/inc/xmos\\srtvbf_xmos.h" 1
# 345 "C:/Users/user/workspace/lib_xbeclear/inc/xmos\\srtvbf_xmos.h"
...
extern "C" {
# 34 "C:/Users/user/workspace/lib_xbeclear/inc/xmos/beclear_channels.h"
...
# 346 "C:/Users/user/workspace/lib_xbeclear/inc/xmos\\srtvbf_xmos.h" 2
...
# 32 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc" 2
...
# 33 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc" 2
...
# 37 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc" 2
...
# 72 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc"
...
select xmos_parameter_bap_tile(server interface control i_control)
{
    ...
    switch (resid) {
      case 0x13:
        unsafe {
          ...
          __builtin_memcpy_xc(&param, payload, sizeof(unsigned));
          ...
          if(param_type == TYPE_FLOAT) {
            __builtin_memcpy_xc(&temp_param_f, &(payload[4]), sizeof(unsigned));
            param_val_f = PFLOAT_Load_f(bap_op, temp_param_f);
            params[0].valptr = &param_val_f;
          } else {
            __builtin_memcpy_xc(&param_val_i, &(payload[4]), sizeof(unsigned));
            params[0].valptr = &param_val_i;
          }
                                                        ;
          SRTVBF_BAP_SetPar(bap_op, params, 1, bap_ap->srtvbf_bap);
      ...
      case 0x16:
        unsafe {
          unsigned cmd_id;
          __builtin_memcpy_xc(&cmd_id, payload, sizeof(unsigned));
          if (cmd_id == 0x00) {

            __builtin_memcpy_xc(&nl_model_start_idx, &(payload[4]), sizeof(unsigned));
            ret = CONTROL_SUCCESS;
          }
        }
        break;
  ...
  case i_control.read_command(control_resid_t resid, control_cmd_t cmd,
    ...
    switch (resid) {
      case 0x13:
        unsafe {
          unsigned param = cmd & 0x3F;
          unsigned param_type = (cmd & 0x40)>>6;
          ...
          if(param_type == TYPE_FLOAT) {
            unsigned float_exp = ((int)(param_val_f >> 32));
            unsigned float_man = ((int)(param_val_f & 0xFFFFFFFF));
            __builtin_memcpy_xc(payload, &float_man, sizeof(unsigned));
            __builtin_memcpy_xc(&(payload[4]), &float_exp, sizeof(unsigned));
          } else {
            __builtin_memcpy_xc(payload, &param_val_i, sizeof(unsigned));
          }

          ret = CONTROL_SUCCESS;
        }
        break;
# 203 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc"
        break;
        ...
        case 0x15:
            unsafe
            {
                ...
                __builtin_memcpy_xc(payload, doaAngle, sizeof(int));
                ret = CONTROL_SUCCESS;
            }
        break;
        ...
        case 0x16:
          unsafe {
            if ((cmd & 0x3F) == 0x01) {
              ...
              BeClear_SRTVBF_Process_GetNLModel(bap_op, w);



              int payload_int_len = payload_len/sizeof(unsigned);
              for (int i=0; i<payload_int_len; i++) {
                __builtin_memcpy_xc(&(payload[i*sizeof(unsigned)]), &w[nl_model_start_idx+i], sizeof(unsigned));
              }
              ret = CONTROL_SUCCESS;
            }
          }
    ...
    switch (resid) {
      ...
      unsafe {
        ...
        if(param_type == TYPE_FLOAT) {
          ...
          params[0].valptr = &param_val_i;
                                                      ...
                                                      ;
        SRTVBF_AEC_SetPar(aec_op, params, 1, aec_ap->srtvbf_aec);
      ...
      unsafe {
        ...
        if (cmd_id == 0x00) {
          ...
          __builtin_memcpy_xc(&aec_filter_start_idx, &(payload[4]), sizeof(unsigned));

          __builtin_memcpy_xc(&aec_filter_mic_idx, &(payload[8]), sizeof(unsigned));
          ret = CONTROL_SUCCESS;
        }
      }
        break;
    ...
    switch (resid) {
      ...
      unsafe {
        ...
        if(param == 62) {
          ...
          beclear_version |= ((1 << 8) | ((1 & 0xF) << 4) | (2 & 0xF))<<8;

          __builtin_memcpy_xc(payload, &beclear_version, sizeof(unsigned));
          ret = CONTROL_SUCCESS;
                                                           ;
          break;
        }
        ...
        if(param_type == TYPE_FLOAT) {
          ...
          params[0].valptr = &param_val_i;
                                                     ...
                                                     ;
        SRTVBF_AEC_GetPar(aec_op, params, 1, aec_ap->srtvbf_aec);
      ...
      unsafe {
        if ((cmd & 0x3F) == 0x02) {
          ...
          APES_FLOAT aec_filter_tuning [ 2048 + 1];

          BeClear_SRTVBF_Process_GetAECCoefs( aec_op, mic_idx, aec_filter_tuning );
          ...
          for (int i=0; i<payload_int_len; i++) {
            __builtin_memcpy_xc(&(payload[i*sizeof(unsigned)]), &aec_filter_tuning[aec_filter_start_idx+i], sizeof(unsigned));
          }
...
# 1 "C:\\\\Users\\\\user\\\\workspace\\\\app_vf_spk_base\\\\.build_1i1o2_lin33_48k_xscopectl_farenddsp\\\\xscope_probes.h" 1 3
# 420 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.3\\target/include\\xscope.h" 2 3
# 393 "C:/Users/user/workspace/module_vocalfusion/src/vf_control.xc" 2
[[combinable]]
void xscope_client(chanend c_xscope, client interface control i_control[(3)])
{
  uint8_t buffer[256];
  int num_bytes_read;
  ...
  control_init();
  control_register_resources(i_control, (3));
  ...
  while (1) {
    select {
      case xscope_data_from_host(c_xscope, buffer, num_bytes_read):
        ...
        if (return_size > 0) {
          do { if ((0) != -1) xscope_core_bytes(0, return_size, buffer); } while (0);
        }
        break;
    }
  }
...
void xscope_user_init(void)
{
  xscope_register(1, XSCOPE_CONTINUOUS, "Control Probe", XSCOPE_INT, "byte");
