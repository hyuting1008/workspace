...
unsigned audioBuffIn[((((((48000/8000+1)*4) * 1 + 4) * 3)>((((48000/1000+1)*4) * 1 + 4) * 3) ? ((((48000/8000+1)*4) * 1 + 4) * 3) : ((((48000/1000+1)*4) * 1 + 4) * 3)) >> 2)+ (((((((48000/1000+1)*4) * 1 + 4))>((((48000/8000+1)*4) * 1 + 4)) ? ((((48000/1000+1)*4) * 1 + 4)) : ((((48000/8000+1)*4) * 1 + 4)))) >> 2)];


unsigned inZeroBuff[(((((((48000/1000+1)*4) * 1 + 4))>((((48000/8000+1)*4) * 1 + 4)) ? ((((48000/1000+1)*4) * 1 + 4)) : ((((48000/8000+1)*4) * 1 + 4)))) >> 2)];
...
int g_maxPacketSize = (((48000/1000+1)*4) * 1 + 4);
...
# 408 "C:/Users/user/workspace/module_usb_audio/usb_buffer/decouple.xc"
        ...
        for(int i = 0; i < 1 - g_numUsbChan_In; i++)
        {
...
# 496 "C:/Users/user/workspace/module_usb_audio/usb_buffer/decouple.xc"
            ...
            if((space_left < (totalSampsToWrite * g_numUsbChan_In * g_curSubSlot_In + 4)))
            {
                ...
                } while(space_left < ((((((48000/8000+1)*4) * 1 + 4) * 3)>((((48000/1000+1)*4) * 1 + 4) * 3) ? ((((48000/8000+1)*4) * 1 + 4) * 3) : ((((48000/1000+1)*4) * 1 + 4) * 3))/2));
            }
...
# 630 "C:/Users/user/workspace/module_usb_audio/usb_buffer/decouple.xc"
    ...
    aud_to_host_fifo_end = aud_to_host_fifo_start + (((((48000/8000+1)*4) * 1 + 4) * 3)>((((48000/1000+1)*4) * 1 + 4) * 3) ? ((((48000/8000+1)*4) * 1 + 4) * 3) : ((((48000/1000+1)*4) * 1 + 4) * 3));
    g_aud_to_host_wrptr = aud_to_host_fifo_start;
...

        {
            ...
            if (sentPkt)
            {
                ...
                if (inUnderflow)
                {
                    ...
                    if (fill_level < 0)
                        fill_level += (((((48000/8000+1)*4) * 1 + 4) * 3)>((((48000/1000+1)*4) * 1 + 4) * 3) ? ((((48000/8000+1)*4) * 1 + 4) * 3) : ((((48000/1000+1)*4) * 1 + 4) * 3));

                    if (fill_level >= ((((((48000/8000+1)*4) * 1 + 4))>((((48000/1000+1)*4) * 1 + 4)) ? ((((48000/8000+1)*4) * 1 + 4)) : ((((48000/1000+1)*4) * 1 + 4)))*2))
                    {
                        inUnderflow = 0;
