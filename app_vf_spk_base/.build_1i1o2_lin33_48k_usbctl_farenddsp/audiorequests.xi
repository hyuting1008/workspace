# 1 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc" 2
...
# 7 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc" 2
...
# 8 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc" 2
...
# 9 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc" 2
...
# 284 "C:/Users/user/workspace/module_usb_shared/src\\usbaudio20.h"
...
# 10 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc" 2
# 1 "C:/Users/user/workspace/module_usb_shared/src/class\\usbaudio10.h" 1
# 11 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc" 2
# 1 "C:/Users/user/workspace/module_usb_audio/endpoint0\\dbcalc.h" 1
# 18 "C:/Users/user/workspace/module_usb_audio/endpoint0\\dbcalc.h"
unsigned db_to_mult(int db, int db_frac_bits, int result_frac_bits);
# 12 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc" 2
# 1 "C:/Users/user/workspace/module_usb_audio\\devicedefines.h" 1
# 13 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc" 2
...
# 14 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc" 2
...
# 15 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc" 2
...
extern unsigned int multIn[1 + 1];
...
# 47 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc"
unsigned int g_curSamFreq = (48000);
# 56 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc"
...
# 274 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc"
...
# 374 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc"
                            ...
                            else
                            {
                                switch(unitID)
                                {
                                    case 42:
                                    case 43:
# 402 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc"
                                    case 41:
                            ...
                            switch(unitID)
                            {
                                ...
                                case 42:
                                    ...
                                    if (!isnull(c_clk_ctl))
                                    {
                                        ...
                                        (buffer, unsigned char[])[0] = __builtin_in_uint(c_clk_ctl);
                        ...
                        if(sp.bmRequestType.Direction == 0 )
                        {
                            ...
                            if(datalength == 1)
                            {
                                if (!isnull(c_clk_ctl))
                                {
                                    ...
                                    __builtin_out_uint(c_clk_ctl, (buffer, unsigned char[])[0]);
                                    __builtin_outct(c_clk_ctl, 0x1);
                                }
...
# 835 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc"
                default:
...
# 879 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc"
...
# 923 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc"
                ...
                case 10:
                    ...
                    switch( sp.wValue >> 8 )
                    {
                        ...
                        case 0x02:
                            ...
                            storeShort((buffer, unsigned char[]), 2, (0x8100));
                            storeShort((buffer, unsigned char[]), 4, (0x0000));
                            storeShort((buffer, unsigned char[]), 6, (0x100));
                    ...
                    break;
# 971 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc"
                default:
...
# 1063 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc"
    }
...
# 1137 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc"
...
{
# 1282 "C:/Users/user/workspace/module_usb_audio/endpoint0/audiorequests.xc"
    return XUD_RES_ERR;
}
