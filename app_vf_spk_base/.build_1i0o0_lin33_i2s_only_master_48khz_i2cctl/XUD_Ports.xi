# 1 "C:/Users/user/workspace/module_xud/src/XUD_Ports.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/user/workspace/module_xud/src/XUD_Ports.xc" 2
...
# 2 "C:/Users/user/workspace/module_xud/src/XUD_Ports.xc" 2

in port flag0_port = on stdcore[1]: 0x10600;
in port flag1_port = on stdcore[1]: 0x10400;
in port flag2_port = on stdcore[1]: 0x10500;


  in buffered port:32 p_usb_clk = on stdcore[1]: 0x10800;
  out buffered port:32 p_usb_txd = on stdcore[1]: 0x80000;
  in buffered port:32 p_usb_rxd = on stdcore[1]: 0x80100;
  out port tx_readyout = on stdcore[1]: 0x10900;
  in port tx_readyin = on stdcore[1]: 0x10700;
  in port rx_rdy = on stdcore[1]: 0x10a00;
