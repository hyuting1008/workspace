# 1 "../src/extensions/userevents.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/extensions/userevents.xc" 2
...
# 4 "../src/extensions/userevents.xc" 2
...
# 6 "../src/extensions/userevents.xc" 2
...
# 7 "../src/extensions/userevents.xc" 2
...
{
# 31 "../src/extensions/userevents.xc"
    int led_angle = angle+180;


    if (led_angle>360) led_angle -= 360;

    int doaLed = (led_angle * 34953) >> 20;
    return doaLed;
}
...
# 136 "../src/extensions/userevents.xc"
}
