# 1 "C:/Users/user/workspace/module_usb_midi/src/usb_midi.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/user/workspace/module_usb_midi/src/usb_midi.xc" 2
...
# 2 "C:/Users/user/workspace/module_usb_midi/src/usb_midi.xc" 2
...
int clz(unsigned x);
# 3 "C:/Users/user/workspace/module_usb_midi/src/usb_midi.xc" 2
...
# 4 "C:/Users/user/workspace/module_usb_midi/src/usb_midi.xc" 2
...
# 5 "C:/Users/user/workspace/module_usb_midi/src/usb_midi.xc" 2
# 1 "C:/Users/user/workspace/module_usb_midi/src\\usb_midi.h" 1
...
# 5 "C:/Users/user/workspace/module_usb_midi/src\\usb_midi.h" 2
# 18 "C:/Users/user/workspace/module_usb_midi/src\\usb_midi.h"
void usb_midi(
...
# 48 "C:/Users/user/workspace/module_usb_midi/src\\usb_midi.h"
#pragma select handler
...
# 6 "C:/Users/user/workspace/module_usb_midi/src/usb_midi.xc" 2
# 1 "C:/Users/user/workspace/module_usb_midi/src\\midiinparse.h" 1
...
# 7 "C:/Users/user/workspace/module_usb_midi/src/usb_midi.xc" 2
# 1 "C:/Users/user/workspace/module_usb_midi/src\\midioutparse.h" 1



{unsigned, unsigned, unsigned, unsigned} midi_out_parse(unsigned event);
# 8 "C:/Users/user/workspace/module_usb_midi/src/usb_midi.xc" 2
# 1 "C:/Users/user/workspace/module_queue/src\\queue.h" 1
...
# 9 "C:/Users/user/workspace/module_usb_midi/src/usb_midi.xc" 2
...
)
{
    ...
    t :> txT;
    t2 :> rxT;
# 135 "C:/Users/user/workspace/module_usb_midi/src/usb_midi.xc"
    {
                ...
                case (!authenticating && isRX) => t2 when __builtin_timer_after(rxT) :> int _ :
                {
                    ...
                    else
                    {
                        ...
                        if ((bit & 0x1) == 1)
                        {
                            ...
                            uin_count++;
                            rxByte >>= 24;
# 190 "C:/Users/user/workspace/module_usb_midi/src/usb_midi.xc"
        ...
        case !authenticating => midi_get_ack_or_data(c_midi, is_ack, datum):
            ...
            else
            {
                ...
                mr_count++;
# 318 "C:/Users/user/workspace/module_usb_midi/src/usb_midi.xc"
            ...
            break;
# 369 "C:/Users/user/workspace/module_usb_midi/src/usb_midi.xc"
            }
        }
    }
}
