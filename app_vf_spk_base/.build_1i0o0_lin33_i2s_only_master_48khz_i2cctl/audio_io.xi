...
# 717 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
 ...
 for(int i = 0; i < 2; i += 2)
                {
                    ...
                    unsigned sample;
                    asm volatile("in %0, res[%1]" : "=r"(sample) : "r"(p_i2s_adc[index++]));
# 874 "C:/Users/user/workspace/module_usb_audio/audio_io/audio_io.xc"
                    sample = __builtin_bitrev(sample);
