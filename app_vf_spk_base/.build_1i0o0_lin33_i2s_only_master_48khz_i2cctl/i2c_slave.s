	...
	.set i2c_slave.select.yield.enable.cases.nstackwords, 0 $M (i2c_slave.select.yield.case.1.nstackwords) $M (i2c_slave.select.yield.case.0.nstackwords) $M (i2c_slave.select.yield.case.2.nstackwords)
	...
	.set _Si2c_slave_0.select.yield.enable.cases.nstackwords, 0 $M (_Si2c_slave_0.select.yield.case.2.nstackwords) $M (_Si2c_slave_0.select.yield.case.0.nstackwords) $M (_Si2c_slave_0.select.yield.case.1.nstackwords)
