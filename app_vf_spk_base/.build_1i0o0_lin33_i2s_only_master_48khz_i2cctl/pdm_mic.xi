# 1 "C:/Users/user/workspace/module_usb_audio/pdm_mics/pdm_mic.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/user/workspace/module_usb_audio/pdm_mics/pdm_mic.xc" 2
...
# 18 "C:/Users/user/workspace/module_quadflash/include\\quadflash.h"
# 1 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.3\\target/include\\xs1_clock.h" 1 3
# 19 "C:/Users/user/workspace/module_quadflash/include\\quadflash.h" 2
...
# 3 "C:/Users/user/workspace/module_usb_audio/pdm_mics/pdm_mic.xc" 2
...
# 9 "C:/Users/user/workspace/module_usb_audio/pdm_mics/pdm_mic.xc" 2
...
# 11 "C:/Users/user/workspace/module_usb_audio/pdm_mics/pdm_mic.xc" 2
...
# 12 "C:/Users/user/workspace/module_usb_audio/pdm_mics/pdm_mic.xc" 2
...
# 13 "C:/Users/user/workspace/module_usb_audio/pdm_mics/pdm_mic.xc" 2
...
int clz(unsigned x);
# 14 "C:/Users/user/workspace/module_usb_audio/pdm_mics/pdm_mic.xc" 2

# 1 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.3\\target/include\\assert.h" 1 3
...
extern "C" {
# 44 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.3\\target/include\\assert.h" 3
...
# 16 "C:/Users/user/workspace/module_usb_audio/pdm_mics/pdm_mic.xc" 2
...
void mic_array_decimator_configure(
        ...
        mic_array_decimator_config_t dc[]);
# 18 "C:/Users/user/workspace/module_usb_audio/pdm_mics/pdm_mic.xc" 2
...
# 19 "C:/Users/user/workspace/module_usb_audio/pdm_mics/pdm_mic.xc" 2




in port p_pdm_clk = on tile[0]: 0x10600;
in buffered port:32 p_pdm_mics = on tile[0]: 0x80100;
in port p_mclk = on tile[0]: 0x10400;
__clock_t pdmclk = on tile[0]: 0x306;

int mic_decimator_fir_data[8][(32) * (96000/(16000/3))] = {{0}};
...

{
    ...
    {
        fir_gain_compen[0] = 0;
        fir_gain_compen[1] = (276212818);
        fir_gain_compen[2] = (285017600);
        fir_gain_compen[3] = (284180149);
        fir_gain_compen[4] = (285084376);
        fir_gain_compen[5] = 0;
        fir_gain_compen[6] = (285567922);
...
# 219 "C:/Users/user/workspace/module_usb_audio/pdm_mics/pdm_mic.xc"
    do { if (!(((512*48000) / 3072000) == ((512*44100) / 2822400))) { __assert ("C:/Users/user/workspace/module_usb_audio/pdm_mics/pdm_mic.xc", 219, "(MCLK_48 / 3072000) == (MCLK_441 / 2822400)"); } } while(0);

    unsigned micDiv = (512*48000)/3072000;

    configure_clock_src_divide(pdmclk, p_mclk, micDiv/2);
    configure_port_clock_output(p_pdm_clk, pdmclk);
    configure_in_port(p_pdm_mics, pdmclk);
    __builtin_start_clock(pdmclk);

    par
    {
        mic_array_pdm_rx(p_pdm_mics, c_4x_pdm_mic_0, null);
        mic_array_decimate_to_pcm_4ch(c_4x_pdm_mic_0, c_ds_output[0], (0));
