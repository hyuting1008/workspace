...
[[combinable]] void xscope_client(chanend c_xscope, client interface control i_control[(2)]);





void i2c_ctrl(client interface control i_control[(2)]);





void spi_ctrl(client interface control i_control[(2)]);
...
# 64 "C:/Users/user/workspace/module_usb_audio/main.xc"
...
on tile[1] : buffered in port:32 p_i2s_adc[(2 / 2)] =
                {on tile[1]: 0x10f00,
# 118 "C:/Users/user/workspace/module_usb_audio/main.xc"
                };
...
# 263 "C:/Users/user/workspace/module_usb_audio/main.xc"
void thread_speed()
{
...
# 417 "C:/Users/user/workspace/module_usb_audio/main.xc"
...
int main()
{
# 573 "C:/Users/user/workspace/module_usb_audio/main.xc"
    chan c_pdm_pcm;
    ...
    interface beclear_if i_beclear; chan chan_aec[4]; chan chan_erl; chan c_led; interface control i_control[(2)];
    par
    {
        on tile[0].core[0]: BeclearBuff(i_audMan, i_beclear); on tile[0]: BeClear_SmartTV_AEC(chan_aec, chan_erl, i_beclear, i_control[0]); on tile[1]: { led_init_chanend(c_led); BeClear_SmartTV_BAP(chan_aec, chan_erl, i_control[1]); } on tile[(0)]: i2c_ctrl(i_control); on tile[0].core[0]: led_controller(c_led);
# 701 "C:/Users/user/workspace/module_usb_audio/main.xc"
        on tile[1]:
        par
        {
# 730 "C:/Users/user/workspace/module_usb_audio/main.xc"
        }

        on tile[1]: usb_audio_io(null, null
...
# 819 "C:/Users/user/workspace/module_usb_audio/main.xc"
