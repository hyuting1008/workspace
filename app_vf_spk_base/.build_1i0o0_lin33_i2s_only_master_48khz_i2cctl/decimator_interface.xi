# 1 "C:/Users/user/workspace/lib_mic_array/src/decimator_interface.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/user/workspace/lib_mic_array/src/decimator_interface.xc" 2
...
# 5 "C:/Users/user/workspace/lib_mic_array/api\\mic_array.h" 2
...
# 5 "C:/Users/user/workspace/module_usb_audio/pdm_mics\\mic_array_conf.h" 2
...
void mic_array_decimator_configure(
        ...
        mic_array_decimator_config_t dc[]);
# 3 "C:/Users/user/workspace/lib_mic_array/src/decimator_interface.xc" 2
...
# 4 "C:/Users/user/workspace/lib_mic_array/src/decimator_interface.xc" 2
...
# 5 "C:/Users/user/workspace/lib_mic_array/src/decimator_interface.xc" 2
...
void mic_array_init_time_domain_frame(
   ...
   _safe_memset((char *)audio, 0, sizeof(mic_array_frame_time_domain)*frames);
   ...
   for(unsigned f=0;f<frames;f++){
    ...
    for(unsigned i=0;i<decimator_count;i++)
        __builtin_schkct(c_from_decimator[i], 8);

    buffer = frames;
}
# 95 "C:/Users/user/workspace/lib_mic_array/src/decimator_interface.xc"
mic_array_frame_time_domain * alias mic_array_get_next_time_domain_frame(
         streaming chanend c_from_decimator[], unsigned decimator_count,
     ...
     for(unsigned i=0;i<decimator_count;i++)
         __builtin_soutct(c_from_decimator[i], 0);
...
void mic_array_init_frequency_domain_frame(streaming chanend c_from_decimator[], unsigned decimator_count,
     ...
     _safe_memset((char *)f_fft_preprocessed, 0, sizeof(mic_array_frame_fft_preprocessed)*frames);
...
void mic_array_decimator_configure(
    ...
    for(unsigned i=0;i<decimator_count;i++)
     ...
     for(unsigned i=0;i<decimator_count;i++)
         __builtin_soutct(c_from_decimator[i], 1);
