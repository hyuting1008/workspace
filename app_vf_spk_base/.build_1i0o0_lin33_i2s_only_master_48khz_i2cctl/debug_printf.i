# 1 "C:/Users/user/workspace/lib_logging/src/debug_printf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 290 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/user/workspace/lib_logging/src/debug_printf.c" 2
...
# 3 "C:/Users/user/workspace/lib_logging/src/debug_printf.c" 2
...
# 4 "C:/Users/user/workspace/lib_logging/src/debug_printf.c" 2
...
# 5 "C:/Users/user/workspace/lib_logging/src/debug_printf.c" 2
...
# 6 "C:/Users/user/workspace/lib_logging/src/debug_printf.c" 2
...
# 7 "C:/Users/user/workspace/lib_logging/src/debug_printf.c" 2
...
# 9 "C:/Users/user/workspace/lib_logging/src/debug_printf.c" 2
...
# 10 "C:/Users/user/workspace/lib_logging/src/debug_printf.c" 2
...
# 56 "C:/Users/user/workspace/lib_logging/src/debug_printf.c"
void debug_printf(char * fmt, ...)
{
  char * marker;
  int intArg;
  ...
  while (*fmt) {
    ...
    case '%':
      ...
      switch (__extension__ ({ int __x = (*(fmt)); ((__ctype_ptr__)[(unsigned)((__x)+1)]&01) ? (__x - 'A' + 'a') : __x;})) {
      case 'd':
