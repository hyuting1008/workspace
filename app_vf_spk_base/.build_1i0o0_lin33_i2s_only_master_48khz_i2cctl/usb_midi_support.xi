# 1 "C:/Users/user/workspace/module_usb_midi/src/usb_midi_support.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/user/workspace/module_usb_midi/src/usb_midi_support.xc" 2
...
# 2 "C:/Users/user/workspace/module_usb_midi/src/usb_midi_support.xc" 2
 ...
 void midi_get_ack_or_data(chanend c, int &is_ack, unsigned int &datum) {
  if (__builtin_testct(c)) {
    ...
    datum = __builtin_in_uint(c);
       ...
       void midi_send_ack(chanend c) {
  __builtin_outct(c, 20);
  __builtin_out_uchar(c, 0);
  __builtin_out_uchar(c, 0);
  __builtin_out_uchar(c, 0);
}
# 4 "C:/Users/user/workspace/module_usb_midi/src/usb_midi_support.xc" 2
