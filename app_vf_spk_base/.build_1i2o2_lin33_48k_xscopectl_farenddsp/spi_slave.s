	...
	.set spi_slave.select.yield.enable.cases.nstackwords, 0 $M (spi_slave.select.yield.case.0.nstackwords) $M (spi_slave.select.yield.case.1.nstackwords)
	...
	.set spi_slave.select.enable.cases.nstackwords, 0 $M (spi_slave.select.case.0.nstackwords) $M (spi_slave.select.case.1.nstackwords)
