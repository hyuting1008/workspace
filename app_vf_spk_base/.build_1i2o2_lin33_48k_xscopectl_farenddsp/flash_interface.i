# 1 "C:/Users/user/workspace/module_dfu/src/flash_interface.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 289 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/user/workspace/module_dfu/src/flash_interface.c" 2
...
# 2 "C:/Users/user/workspace/module_dfu/src/flash_interface.c" 2
...
# 3 "C:/Users/user/workspace/module_dfu/src/flash_interface.c" 2
# 1 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.3\\target/include\\flashlib.h" 1 3
# 26 "C:\\Program Files (x86)\\XMOS\\xTIMEcomposer\\Community_14.3.3\\target/include\\flashlib.h" 3
...
# 4 "C:/Users/user/workspace/module_dfu/src/flash_interface.c" 2
...
# 5 "C:/Users/user/workspace/module_dfu/src/flash_interface.c" 2
...
int clz(unsigned x);
# 6 "C:/Users/user/workspace/module_dfu/src/flash_interface.c" 2
# 23 "C:/Users/user/workspace/module_dfu/src/flash_interface.c"
...
static void begin_write()
{
    ...
    do
    {
        result = fl_startImageAdd(&factory_image, 512*1024, 0);
    } while (result > 0);
