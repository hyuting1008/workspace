...
# 50 "C:/Users/user/workspace/module_usb_audio/endpoint0/descriptor_defs.h"
...
# 65 "C:/Users/user/workspace/module_usb_audio/endpoint0/descriptors.h"
    char *dfuStr;
# 75 "C:/Users/user/workspace/module_usb_audio/endpoint0/descriptors.h"
...
# 338 "C:/Users/user/workspace/module_usb_audio/endpoint0/descriptors.h"
    .dfuStr = "XMOS"" ""DFU",
# 348 "C:/Users/user/workspace/module_usb_audio/endpoint0/descriptors.h"
...
# 1328 "C:/Users/user/workspace/module_usb_audio/endpoint0/chanstrings.h"
    ...
    .inputChanStr_2 = ""
# 1368 "C:/Users/user/workspace/module_usb_audio/endpoint0/chanstrings.h"
        ,
...
unsigned char cfgDesc_Audio1[] =
{
    ...
    0x09,
    USB_DESCTYPE_CONFIGURATION,
    ((18 + ((8 + (1) + (1)) + ((1) * (12 + ( (8 + 2) * 0) + 9)) + ((1) * (12 + ( (8 + 2) * 0) + 9))) + ((1) * (49 + num_freqs_a1 * 3)) + ((1) * (58 + num_freqs_a1 * 3)) + 0 + 18) & 0xFF),
    ((18 + ((8 + (1) + (1)) + ((1) * (12 + ( (8 + 2) * 0) + 9)) + ((1) * (12 + ( (8 + 2) * 0) + 9))) + ((1) * (49 + num_freqs_a1 * 3)) + ((1) * (58 + num_freqs_a1 * 3)) + 0 + 18) >> 8),
    (1+(1) + (1)+0 +1),
    0x01,
    0x00,
    ...
    0x01,
    0x00, 0x01,
    (((8 + (1) + (1)) + ((1) * (12 + ( (8 + 2) * 0) + 9)) + ((1) * (12 + ( (8 + 2) * 0) + 9))) & 0xFF),
    (((8 + (1) + (1)) + ((1) * (12 + ( (8 + 2) * 0) + 9)) + ((1) * (12 + ( (8 + 2) * 0) + 9))) >> 8),
    ((1) + (1)),
...
# 2722 "C:/Users/user/workspace/module_usb_audio/endpoint0/descriptors.h"
    ...
    (((((48000 +999)/1000)+1) * 2) * (16/8))&0xff,
    ((((((48000 +999)/1000)+1) * 2) * (16/8))&0xff00)>>8,
    0x01,
    0x00,
    0x00,
    ...
    0x10,
    0x01,
# 2785 "C:/Users/user/workspace/module_usb_audio/endpoint0/descriptors.h"
};
...
const unsigned g_chanCount_In_HS[1] = {2,
...
# 623 "C:/Users/user/workspace/module_usb_audio/endpoint0/endpoint0.c"
...

        {
            if(result == XUD_RES_ERR)
            {
                ...
                result = VendorRequests(ep0_out, ep0_in, &sp );
            }
        }
