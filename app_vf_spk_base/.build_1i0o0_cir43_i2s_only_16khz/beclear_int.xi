...
# 18 "C:/Users/user/workspace/module_vocalfusion/src/beclear_int.xc" 2
...
# 311 "C:/Users/user/workspace/lib_xbeclear/inc/xmos\\ambiphone_xmos.h"
extern "C" {
...
# 139 "C:/Users/user/workspace/lib_xbeclear/inc\\beclear_application_smarthome.h"
}
# 30 "C:/Users/user/workspace/module_vocalfusion/src/beclear_int.xc" 2
...
# 53 "C:/Users/user/workspace/module_vocalfusion/src/beclear_int.xc"
...
# 257 "C:/Users/user/workspace/module_vocalfusion/src/beclear_int.xc"
    if ((1) > 1)
    {
        if (((1) - 1) == usbToBeclearRatioCounter)
        {
            for (int i = 0; i < 1; ++i)
            {
    ...
    if (((1) - 1) == usbToBeclearRatioCounter)
    {
        ...
        for(int i = 0; i < 4; i++)
        {
            inputNear[i] = sampsFromAudioToUsb[2 +i] << 2;
        }
    ...
    if ((1) > 1)
    {
        ...
        {
            size_t index = ((1)-1) - usbToBeclearRatioCounter - 1;
    ...
    if (2 > 0)
    {

        {
            ...
            sampsFromUsbToAudio[1] = ((0)) ? asrOutput : commOutput;



        }
# 365 "C:/Users/user/workspace/module_vocalfusion/src/beclear_int.xc"
    }
# 381 "C:/Users/user/workspace/module_vocalfusion/src/beclear_int.xc"
    if (2 > 0)
    {
        switch (2)
        {
...
# 475 "C:/Users/user/workspace/module_vocalfusion/src/beclear_int.xc"
            ...
            q8_24 doa1 = pfloat_to_q24(((int)(td_doa1 >> 32)), ((int)(td_doa1 & 0xFFFFFFFF)));
