...
# 16 "C:/Users/user/workspace/module_usb_audio/main.xc" 2
...
# 21 "C:/Users/user/workspace/module_usb_audio/main.xc" 2
...
# 47 "C:/Users/user/workspace/module_usb_audio/main.xc"
...
# 48 "C:/Users/user/workspace/module_usb_audio/main.xc" 2
...
# 60 "C:/Users/user/workspace/module_usb_audio/main.xc"
on tile[1] : buffered out port:32 p_i2s_dac[(2 / 2)] =
                {on tile[1]: 0x10300,
# 85 "C:/Users/user/workspace/module_usb_audio/main.xc"
                };
...
on tile[1] : buffered in port:32 p_i2s_adc[(2 / 2)] =
                {on tile[1]: 0x10100,
# 114 "C:/Users/user/workspace/module_usb_audio/main.xc"
                };
# 123 "C:/Users/user/workspace/module_usb_audio/main.xc"
...
# 181 "C:/Users/user/workspace/module_usb_audio/main.xc"
...
# 258 "C:/Users/user/workspace/module_usb_audio/main.xc"
void thread_speed()
{
...
# 412 "C:/Users/user/workspace/module_usb_audio/main.xc"
...
{
# 443 "C:/Users/user/workspace/module_usb_audio/main.xc"
    par
    {
# 453 "C:/Users/user/workspace/module_usb_audio/main.xc"
        {
            thread_speed();
...
# 488 "C:/Users/user/workspace/module_usb_audio/main.xc"
    }
}
# 502 "C:/Users/user/workspace/module_usb_audio/main.xc"
int main()
{
# 567 "C:/Users/user/workspace/module_usb_audio/main.xc"
    ...
    interface beclear_if i_beclear; chan chan_aec[4]; chan chan_erl; chan c_led;
    par
    {
        on tile[0].core[0]: BeclearBuff(i_audMan, i_beclear); on tile[0]: BeClear_SmartHome_AEC(chan_aec, chan_erl, i_beclear, null); on tile[1]: { led_init_chanend(c_led); BeClear_SmartHome_BAP(chan_aec, chan_erl, null); } on tile[0].core[0]: led_controller(c_led);

        on tile[1]:
        par
        {
# 610 "C:/Users/user/workspace/module_usb_audio/main.xc"
        }
...
# 699 "C:/Users/user/workspace/module_usb_audio/main.xc"
