...
unsigned char cfgDesc_Audio1[] =
{
    ...
    0x09,
    USB_DESCTYPE_CONFIGURATION,
    ((18 + ((8 + (1) + (1)) + ((1) * (12 + ( (8 + 2) * 0) + 9)) + ((1) * (12 + ( (8 + 2) * 0) + 9))) + ((1) * (49 + num_freqs_a1 * 3)) + ((1) * (58 + num_freqs_a1 * 3)) + 9 + 18) & 0xFF),
    ((18 + ((8 + (1) + (1)) + ((1) * (12 + ( (8 + 2) * 0) + 9)) + ((1) * (12 + ( (8 + 2) * 0) + 9))) + ((1) * (49 + num_freqs_a1 * 3)) + ((1) * (58 + num_freqs_a1 * 3)) + 9 + 18) >> 8),
    (1+(1) + (1)+1 +1),
    0x01,
    0x00,
