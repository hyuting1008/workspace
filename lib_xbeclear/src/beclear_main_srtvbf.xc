...
)
{
    ...
    BeClear_SRTVBF_AecInit( aec_op0, aec_op1, aec_op2, xscope_data_in );
    #else
    ...
    while( GoOn )
    {
        ...
        /*--------------------------------------------------------------------*/
        #if( XSCOPE_FILE_IN_ONOFF == 1 || BECLEAR_CHAN_IN_ONOFF == 1 )
        GoOn = BeClear_SRTVBF_ReadInput( xscope_data_in );
        #else
        ...
        {
            BeClear_SRTVBF_WriteAecCoefs( aec_op0 );
    ...
    BeClear_SRTVBF_AecMemoryUsage( aec_op0, aec_op1, aec_op2 );
    #endif

    #if( TEST_AEC_API == 1 )
    PROBE_START( aec[ 0 ], a0[ 0 ] );
    BeClear_Test_SRTVBF_AEC_Close( aec_op0 );
    PROBE_END( aec[ 0 ], a0[ 0 ], a1[ 0 ], "AEC[0].AEC_Close" );

    PROBE_START( aec[ 0 ], a0[ 0 ] );
    BeClear_Test_SRTVBF_AEC_Init( aec_op0 );
    PROBE_END( aec[ 0 ], a0[ 0 ], a1[ 0 ], "AEC[0].AEC_Init" );

    PROBE_START( aec[ 0 ], a0[ 0 ] );
    BeClear_Test_SRTVBF_AEC_InitApp();
    PROBE_END( aec[ 0 ], a0[ 0 ], a1[ 0 ], "AEC[0].AEC_InitApp" );

    PROBE_START( aec[ 0 ], a0[ 0 ] );
    BeClear_Test_SRTVBF_AEC_SetPar( aec_op0 );
    PROBE_END( aec[ 0 ], a0[ 0 ], a1[ 0 ], "AEC[0].AEC_SetPar" );

    PROBE_START( aec[ 0 ], a0[ 0 ] );
    BeClear_Test_SRTVBF_AEC_GetPar( aec_op0 );
    PROBE_END( aec[ 0 ], a0[ 0 ], a1[ 0 ], "AEC[0].AEC_GetPar" );

    PROBE_START( aec[ 0 ], a0[ 0 ] );
    BeClear_Test_SRTVBF_GetAECCoefs( aec_op0 );
    PROBE_END( aec[ 0 ], a0[ 0 ], a1[ 0 ], "AEC[0].GetAECCoefs" );

    PROBE_START( aec[ 0 ], a0[ 0 ] );
    BeClear_Test_SRTVBF_SetAECCoefs( aec_op0 );
    PROBE_END( aec[ 0 ], a0[ 0 ], a1[ 0 ], "AEC[0].SetAECCoefs" );
...
)
{
    ...
    while( GoOn )
    {
        ...
        {
            {
                ...
                PROBE_START( bap[ 0 ], b0[ 0 ] );
                BeClear_SRTVBF_FsbFilterRefMic( bap_op0, 1 );
                PROBE_END( bap[ 0 ], b0[ 0 ], b1[ 0 ], "BAP[0].FsbFilterRefMic1" );
                PROBE_START( bap[ 0 ], b0[ 0 ] );
                BeClear_SRTVBF_FsbUpdateDelaylineMic( bap_op0, 1 );
                PROBE_END( bap[ 0 ], b0[ 0 ], b1[ 0 ], "BAP[0].FsbUpdateDelaylineMic1" );
                #endif
            }
            {
                set_core_high_priority_on();
        ...
        PROBE_START( bap[ 0 ], b0[ 0 ] );
        BeClear_SRTVBF_FsbUpdateGainFunction( bap_op0 );
        PROBE_END( bap[ 0 ], b0[ 0 ], b1[ 0 ], "BAP[0].FsbUpdateGainFunction" );
        ...
        {
            {
                ...
                {
                #if( BECLEAR_CHAN_OUT_ONOFF == 1)
                    BeClear_SRTVBF_WriteOutput(bap_data_out);
                #else
        ...
        {
            {
                ...
                PROBE_START( bap[ 0 ], b0[ 0 ] );
                BeClear_SRTVBF_FsbUpdate( bap_op0, 0 );
                PROBE_END( bap[ 0 ], b0[ 0 ], b1[ 0 ], "BAP[0].FsbUpdate0" );
                #if( NMICS > 1 )
                PROBE_START( bap[ 0 ], b0[ 0 ] );
                BeClear_SRTVBF_FsbUpdate( bap_op0, 1 );
                PROBE_END( bap[ 0 ], b0[ 0 ], b1[ 0 ], "BAP[0].FsbUpdate1" );
                #endif
            }
            {
                set_core_high_priority_on();
    ...
    #if( SHOW_MEMORY_INFO == 1 )
    BeClear_SRTVBF_BapMemoryUsage( bap_op0, bap_op1 );
    #endif

    #if( TEST_BAP_API == 1 )
    PROBE_START( bap[ 0 ], b0[ 0 ] );
    BeClear_Test_SRTVBF_BAP_Close( bap_op0 );
    PROBE_END( bap[ 0 ], b0[ 0 ], b1[ 0 ], "BAP[0].BAP_Close" );

    PROBE_START( bap[ 0 ], b0[ 0 ] );
    BeClear_Test_SRTVBF_BAP_Init( bap_op0 );
    PROBE_END( bap[ 0 ], b0[ 0 ], b1[ 0 ], "BAP[0].BAP_Init" );

    PROBE_START( bap[ 0 ], b0[ 0 ] );
    BeClear_Test_SRTVBF_BAP_InitApp();
    PROBE_END( bap[ 0 ], b0[ 0 ], b1[ 0 ], "BAP[0].BAP_InitApp" );

    PROBE_START( bap[ 0 ], b0[ 0 ] );
    BeClear_Test_SRTVBF_BAP_SetPar( bap_op0 );
    PROBE_END( bap[ 0 ], b0[ 0 ], b1[ 0 ], "BAP[0].BAP_SetPar" );

    PROBE_START( bap[ 0 ], b0[ 0 ] );
    BeClear_Test_SRTVBF_BAP_GetPar( bap_op0 );
    PROBE_END( bap[ 0 ], b0[ 0 ], b1[ 0 ], "BAP[0].BAP_GetPar" );

    PROBE_START( bap[ 0 ], b0[ 0 ] );
    BeClear_Test_SRTVBF_SetMicPositions( bap_op0 );
    PROBE_END( bap[ 0 ], b0[ 0 ], b1[ 0 ], "BAP[0].SetMicPositions" );

    PROBE_START( bap[ 0 ], b0[ 0 ] );
    BeClear_Test_SRTVBF_GetNLModelSize( bap_op0 );
    PROBE_END( bap[ 0 ], b0[ 0 ], b1[ 0 ], "BAP[0].GetNLModelSize" );

    PROBE_START( bap[ 0 ], b0[ 0 ] );
    BeClear_Test_SRTVBF_SetNLModel( bap_op0 );
    PROBE_END( bap[ 0 ], b0[ 0 ], b1[ 0 ], "BAP[0].SetNLModel" );

    PROBE_START( bap[ 0 ], b0[ 0 ] );
    BeClear_Test_SRTVBF_GetNLModel( bap_op0 );
