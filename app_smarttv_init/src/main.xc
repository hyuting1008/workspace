...
/*============================================================================*/
void BeClear_SmartTV_AEC ( chanend chan_aec[ NMICS ],
                           chanend chan_erl
...
void BeClear_SmartTV_BAP ( chanend chan_aec[ NMICS ],
                           chanend chan_erl
                           , server control_if ?i_control
 );
...
int main( void )
{
    ...
    par
    {
        ...
        on tile[0]:
        {
            BeClear_SmartTV_AEC( chan_aec, chan_erl, xscope_data_in, null );
        ...
        on tile[0]:
        {
            BeClear_SmartTV_AEC( chan_aec, chan_erl, null );
            #if( BECLEAR_RUN_MODE == 1 )
            c <: 0;
            #endif
        }
        ...
        on tile[1]:
        {
            ...
            c :> int _;
            #endif
            BeClear_SmartTV_BAP( chan_aec, chan_erl, null );
        }
    }
